...
//		console.log(ll);
		...
		var chartNum = totalnumber;
		var chartsArray = new Array();
		for (i=0;i<chartNum;i++) {
			if (i==14) {
				chartsArray[i] = echarts.init(document.getElementById('item'+(i)),'macarons');
			} else{
				chartsArray[i] = echarts.init(document.getElementById('item'+(i)),'infographic');
			}
		}
